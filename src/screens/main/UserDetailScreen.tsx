...
const getUserData = userId => ({
  ...
  photos: [
    ...
    `https://randomuser.me/api/portraits/${
      userId === 'user1' || userId === 'user3' ? 'women' : 'men'
    }/${userId === 'user1' ? 15 : userId === 'user2' ? 33 : 45}.jpg`,
    `https://randomuser.me/api/portraits/${
      userId === 'user1' || userId === 'user3' ? 'women' : 'men'
    }/${userId === 'user1' ? 19 : userId === 'user2' ? 35 : 46}.jpg`,
  ],
  bio:
    userId === 'user1'
      ...
      <View style={styles.photoContainer}>
        ...
        <TouchableOpacity
          ...
          <Text
            style={[
              ...
              currentPhotoIndex === 0 && styles.photoArrowDisabled,
            ]}>
            {'<'}
          </Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          <Text
            style={[
              styles.photoArrowText,
              (!user || currentPhotoIndex === user.photos.length - 1) &&
            ...
            <View>
              ...
              {activeProximityEvent && (
                <Text style={styles.userDistance}>
                  {activeProximityEvent.distance}m away
                </Text>
              )}
            </View>
